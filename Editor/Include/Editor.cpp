                     ...
                     _In_ int       nCmdShow)
{
    ...
    CMainEditorApp* pMainEditorApp = CMainEditorApp::Create();
    if (nullptr == pMainEditorApp)
        return FALSE;
    ...
    while (true)
    {
        ...
        else
        {
            ...
            {
                pMainEditorApp->Update_MainApp(0.f);
                pMainEditorApp->LateUpdate_MainApp(0.f);
                pMainEditorApp->Render_MainApp();
